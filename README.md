...
Appointment scheduling and management microservice for the CareNest healthcare platform.
...
```
jayadevarun2003/carenest-appointment-service:latest
jayadevarun2003/carenest-appointment-service:sha-abc1234
jayadevarun2003/carenest-appointment-service:v1.2.0     ← only when git tag exists
```
...
```bash
# Build locally
docker build -t carenest-appointment-service .

# Run locally
docker run -p 3002:3002 --env-file .env carenest-appointment-service
```
...
# trigger pipeline Sat Apr 25 10:53:03 UTC 2026
# sonarqube ip update Sat Apr 25 18:59:07 UTC 2026
